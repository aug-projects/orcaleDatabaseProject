...
public class AddNewProduct extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        name.setForeground(new java.awt.Color(5, 5, 78));
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        try {
            if (!(name.getText().equals("") || price.getText().equals("") || (quantiy.getText().equals("")) || description.getText().equals("") || combo.getSelectedIndex() == -1)) {
                ...
                if (insertNewProductActionListener.insertNewProductListener(product,idDepartment)) {
